...
export const FRAMEWORK_STEPS: FrameworkStep[] = [
  {
    ...
    phrases: [
      "Well, looking at the situation, I believe that [your choice] is the best option among the three.",
      "If I had to choose between these three options, I would definitely go with [your choice].",
      "In this situation, I think [your choice] is the most practical and suitable choice.",
      "To solve this problem, I strongly believe that choosing [your choice] is the best way to go."
    ],
    color: "#2563EB",
    textColor: "#1E40AF"
  },
  {
    ...
    phrases: [
      "First of all, [your choice] is a great option because ...",
      "The main benefit of choosing this is that ...",
      "Another good thing about this choice is ...",
      "For example, from my own experience, this can help us ...",
      "I think this is highly effective because it can easily solve the problem of ..."
    ],
    color: "#16A34A",
    textColor: "#166534"
  },
  {
    ...
    phrases: [
      "On the other hand, if we look at the other options, [option 1] is not a good idea because ...",
      "As for [option 2], although it has some good points, a big problem with it is ...",
      "Compared to my choice, the other options are not as practical or affordable.",
      "Also, unlike [your choice], both of these options are highly dependent on ...",
      "Therefore, we should not choose the other two options because they are not very suitable."
    ],
    color: "#D97706",
    textColor: "#92400E"
  },
  {
    ...
    phrases: [
      "To sum up, although all three ideas are interesting, I still think [your choice] is the most useful solution.",
      "All in all, because of its convenience and low cost, [your choice] is definitely the best option.",
      "For these reasons, I am confident that [your choice] is the best way to go.",
      "That is why choosing [your choice] is the most sensible decision. Thank you for listening."
    ],
    color: "#9333EA",
    textColor: "#6B21A8"
  }
...
export const TOPICS: Topic[] = [
  {
    ...
    bandAnswers: {
      C1: {
        ...
        note: "C1 — Kịch bản lập luận xuất sắc đạt điểm tuyệt đối (9.0-10.0). Hành văn cực kỳ tự nhiên, sử dụng lối diễn đạt sinh động chuẩn bản xứ (definitely the way to go, pulls people in, let's be honest, put a city on the map) kết hợp khéo léo với thành ngữ 'putting the cart before the horse'."
      },
      B2: {
        ...
        note: "B2 — Kịch bản lập luận rõ ràng đạt chuẩn B2 (6.5-8.0). Sử dụng lối hành văn gãy gọn, từ nối tự nhiên (To start with, On the other hand, Plus). Lập luận thực tế, mạch lạc và dễ hiểu."
      },
      B1: {
        ...
        note: "B1 — Kịch bản chuẩn bị đạt chuẩn B1 (4.0-5.5). Diễn đạt mạch lạc ở mức cơ bản, từ vựng đơn giản, cấu trúc câu trực diện và tự nhiên cho việc lập luận."
      }
    }
  },
  {
    ...
    bandAnswers: {
      C1: {
        ...
        note: "C1 — Kịch bản lập luận cực kỳ tự nhiên, kết cấu chặt chẽ như một bài luận chuẩn mực thực thụ. Kết hợp hài hòa giữa từ vựng tâm lý giáo dục (growth mindset, intrinsic motivation) và các từ đệm liên kết tự nhiên (Well, On top of that, let's be honest, to sum up)."
      },
      B2: {
        ...
        note: "B2 — Kịch bản lập luận đạt chuẩn B2 (6.5-8.0) với phong cách viết mạch lạc, tự nhiên. Trình bày cực kỳ gãy gọn, lập luận thuyết phục tập trung vào tính khả thi tài chính và tâm lý học sinh."
      },
      B1: {
        ...
        note: "B1 — Đạt yêu cầu lập luận ở mức cơ bản. Từ vựng đơn giản, diễn đạt dễ hiểu, giải thích rõ ràng được bản chất vấn đề bằng các câu văn trực diện."
      }
    }
  },
  {
    ...
    bandAnswers: {
      C1: {
        ...
        note: "C1 — Kịch bản lập luận có mạch liên kết xuất sắc, thực tế và dễ ứng dụng. Vừa tự nhiên vừa chứa các từ vựng học thuật chất lượng cao (essential foundation, immune system, stable energy, fall flat, coordinate schedules, proper nutrition)."
      },
      B2: {
        ...
        note: "B2 — Lập luận cực kỳ thực tế, đánh giá đúng tâm lý 'lười đi tập' của dân văn phòng. Văn phong diễn đạt mạch lạc, lập luận thuyết phục và tự nhiên."
      },
      B1: {
        ...
        note: "B1 — Các luận điểm mang tính thực tế cao dẫu từ vựng đơn giản. Câu văn ngắn nhưng nối tiếp hợp lý, giải thích rõ ràng được lí do vì sao ăn uống lại là ưu tiên đầu tiên."
      }
    }
  }
];
